...
WHERE Type NOT IN ('CIVILIZATION_DREAMERS', 'CIVILIZATION_SNOBAR', 'CIVILIZATION_AZRACS', 'CIVILIZATION_ORCS');
...
WHERE Type NOT IN ('CIVILIZATION_DREAMERS', 'CIVILIZATION_DWARVES');
